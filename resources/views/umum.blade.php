...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('front/assets/img/favicons/favicon.ico')}}">
  ...
  <body>
    ...
    <main class="main" id="top">
      <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand d-flex align-items-center fw-semi-bold fs-3" href="index.html"> <img class="me-3" src="{{asset('front/assets/img/gallery/logo.png')}}" alt="" /></a>
          <button class="navbar-toggler collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto pt-0 pt-lg-0 font-base">
            
            </ul>
              <div class="nav-item px-2" data-anchor="data-anchor"><a class="nav-link fw-medium active" aria-current="page" href="index.html">Home</a></div>
              <form class="ps-lg-1">
              <a href="{{url('/')}}" class="btn btn-lg btn-secondary">Staff</a>
  ...
  <div class="d-lg-flex half">
        <div class="bg-holder d-none d-md-block" style="background-image:url({{asset('front/img/bts1.jpg')}});background-position:right bottom;background-size:620px 950px; ">
        </div>
        <!--/.bg-holder-->
        ...
        <div class="container">
          <div class="row align-items-center min-vh-md-75 mt-7">
            <div class="col-md-7 col-lg-6 py-6 text-sm-start text-center">
              <h1 class="mt-6 mb-sm-4 display-4 fw-light lh-sm fs-4 fs-lg-6 fs-xxl-7">Your Self <span class="text-primary"> BTSConcert</span><br class="d-block d-lg-none d-xl-block" />Let's Join </h1>
              <p class="mb-5 fs-1 lh-lg">we will assist you in purchasing BTS concert tickets in order for BTS to travel the world, making sure you watch comfortably and enjoy it</p><a class="btn btn-lg btn-primary hover-top btn-glow" href="{{url('buy')}}">Buy Tickets
